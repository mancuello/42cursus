...
/*   Updated: 2025/03/10 22:07:28 by mcuello          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	load_sprites(t_game *game)
{
	...
	//	game->floor = mlx_xpm_file_to_image(game->mlx, "textures/player.xpm", &width, &height);
	...
	if (!game->player || !game->collect || !game->exit || !game->wall)
	{
